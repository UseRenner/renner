...
export default async function PreviewHowItWorksIndex() {
  const viewer = await getViewer();
  const showCta = !viewer;

  return (
    <div style={{ backgroundColor: "#fbfbfc", color: INK, minHeight: "100vh" }}>
      {/* ─── Compact header with running rule ─── */}
      <header
        style={{
      ...
      <main
        style={{
          padding: "clamp(56px, 7vw, 96px) clamp(28px, 4vw, 64px) clamp(96px, 12vw, 144px)",
          maxWidth: "1280px",
          margin: "0 auto",
        }}
      >
        <IndexBody showCta={showCta} />
            ...
            >
              ...
              <p
                style={{
                  ...
                  lineHeight: 1.6,
                  marginTop: 16,
                  marginLeft: "clamp(76px, 10vw, 100px)",
                  marginBottom: 0,
                  maxWidth: 680,
                  fontVariationSettings: '"opsz" 14',
                }}
