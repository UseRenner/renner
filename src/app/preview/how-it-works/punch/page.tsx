...
import { PunchBody } from "./PunchBody";

export const metadata = {
  title: "How it works · Punch · Renner",
...
export default async function PunchHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;
  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="punch" />
      ...
      <main style={{ padding: "clamp(40px, 6vw, 80px) 0 clamp(96px, 12vw, 160px)" }}>
        <PunchBody showCta={showCta} />
      </main>
