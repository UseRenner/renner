...
export const metadata = {
  title: "How it works · Spread · Renner",
...
export default async function SpreadHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;

  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="spread" />
      ...
      <main style={{ padding: "clamp(48px, 7vw, 96px) clamp(28px, 4vw, 64px) clamp(96px, 12vw, 160px)" }}>
