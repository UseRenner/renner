...
import { TriptychBody } from "./TriptychBody";

export const metadata = { title: "How it works · Triptych · Renner", robots: { index: false, follow: false } };
...
export default async function TriptychHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;
  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="triptych" />
