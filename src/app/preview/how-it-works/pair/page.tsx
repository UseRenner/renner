...
export const metadata = { title: "How it works · Pair · Renner", robots: { index: false, follow: false } };
...
export default async function PairHowItWorks() {
