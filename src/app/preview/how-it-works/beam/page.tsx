...
import { BeamBody } from "./BeamBody";

export const metadata = {
  title: "How it works · Beam · Renner",
...
export default async function BeamHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;
  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="beam" />
