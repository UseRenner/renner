...
import { StrataBody } from "./StrataBody";

export const metadata = {
  title: "How it works · Strata · Renner",
...
export default async function StrataHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;

  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh", overflowX: "hidden" }}>
      <VariantSwitcher active="strata" />
      ...
      <main>
        <StrataBody showCta={showCta} />
      </main>

      <section style={{ padding: "clamp(72px, 10vw, 144px) clamp(28px, 4vw, 64px) clamp(96px, 12vw, 160px)" }}>
