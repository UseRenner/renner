...
import { PlatBody } from "./PlatBody";

export const metadata = {
  title: "How it works · Plat · Renner",
...
export default async function PlatHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;

  return (
    <div style={{ backgroundColor: PAPER, color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="plat" />
