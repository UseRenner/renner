...
const CLIENT_STEPS: Step[] = [
  ...
  { number: "03", title: "It gets done.", body: "The Renner sends photo confirmation. You confirm. Done.", proof: "Escrow", illustration: "completion" },
];
const RENNER_STEPS: Step[] = [
  ...
  { number: "02", title: "Pick a task.", body: "See tasks posted in your area. Apply to the ones that fit your skills and schedule.", proof: "Local", illustration: "browse" },
  { number: "03", title: "It gets done.", body: "Complete the task. Send photo confirmation. Done.", proof: "100% of pay", illustration: "done" },
];
