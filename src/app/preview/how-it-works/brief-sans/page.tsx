...
import { BriefSansBody } from "./BriefSansBody";

export const metadata = {
  title: "How it works · Brief Sans · Renner",
...
export default async function BriefSansHowItWorks() {
  const viewer = await getViewer();
  const showCta = !viewer;

  return (
    <div style={{ backgroundColor: "#fbfbfc", color: INK, minHeight: "100vh" }}>
      <VariantSwitcher active="brief-sans" />
