...
export const metadata = { title: "How it works · Plate · Colon · Renner", robots: { index: false, follow: false } };
...
export default async function PlateColonHowItWorks({ searchParams }: { searchParams: Promise<{ tone?: string }> }) {
