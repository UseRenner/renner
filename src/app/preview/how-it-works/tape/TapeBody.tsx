...
const CLIENT_STEPS: Step[] = [
  ...
  { id: "done", number: "03", title: "It gets done.", body: "The Renner sends photo confirmation. You confirm. Payment is released.", proof: "Escrow" },
];
...
const RENNER_STEPS: Step[] = [
  ...
  { id: "pick", number: "02", title: "Apply to tasks.", body: "See tasks posted in your area. Apply to the ones that fit your skills and schedule.", proof: "Local" },
  { id: "done", number: "03", title: "Take care of it.", body: "Complete the task with care. Send photo confirmation. Receive payment.", proof: "100% of pay" },
];
