...
const CLIENT_STEPS: Step[] = [
  ...
  { id: "pick", number: "02", title: "Pick a Renner.", body: "Vetted Renners apply. Read the file. Book one.", proof: "Checkr-vetted" },
...
const RENNER_STEPS: Step[] = [
  ...
  { id: "pick", number: "02", title: "Pick a task.", body: "Briefs from agents and managers nearby. Apply.", proof: "Local" },
...
export function TapeBody({ showCta }: { showCta: boolean }) {
  ...
  return (
    <>
      ...
      {/* Lede — set quietly under the tape */}
      <p
        style={{
          fontFamily: SERIF,
          fontWeight: 400,
      ...
      {/* Step articles, anchored to tape cells */}
      <div style={{ marginBottom: "clamp(64px, 8vw, 96px)" }}>
        {steps.map((s, i) => (
          <article
            ...
            className="tape-article"
          >
            <div style={{ fontFamily: MONO, fontSize: 12, fontWeight: 500, letterSpacing: "0.24em", color: STEEL_500 }}>
              {s.number}
            </div>
            <div>
              <h3
