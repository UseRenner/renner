...
const CLIENT_STEPS: Step[] = [
  ...
  { id: "done", number: "03", title: "It gets done.", body: "The Renner sends photo confirmation. You confirm. Done.", proof: "Escrow" },
];
...
const RENNER_STEPS: Step[] = [
  ...
  { id: "pick", number: "02", title: "Pick a task.", body: "See tasks posted in your area. Apply to the ones that fit your skills and schedule.", proof: "Local" },
  { id: "done", number: "03", title: "It gets done.", body: "Complete the task. Send photo confirmation. Done.", proof: "100% of pay" },
];
