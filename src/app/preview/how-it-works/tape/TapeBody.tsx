...
const CLIENT_STEPS: Step[] = [
  ...
  { id: "done", number: "03", title: "It gets done.", body: "The Renner sends photo confirmation. You confirm.", proof: "Escrow" },
];
...
const RENNER_STEPS: Step[] = [
  ...
  { id: "done", number: "03", title: "It gets done.", body: "Complete the task. Send photo confirmation.", proof: "100% of pay" },
];
