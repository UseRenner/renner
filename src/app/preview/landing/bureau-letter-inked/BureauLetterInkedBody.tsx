...
// Bureau — LETTER WALL · INKED.
// Same editorial stationery composition as Letter — masthead
// hairline, narrow centered reading column, fields-in-page
// form. The only difference: the categories strip is rendered
// at a slightly larger size and in INK rather than STEEL_700,
// so it carries more presence in the body. The original Letter
// keeps the strip quiet (a continuation of the prose); this
// variation lets the categories read as a deliberate list.

export function BureauLetterInkedBody({ tone }: { tone: ShellTone }) {
  return (
