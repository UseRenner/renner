...
// Bureau — SPECIMEN WALL · BOLD.
// Same Specimen composition with the categories block fully
// inked: italic-serif categories rendered in INK and bracketed
// by INK rules (not STEEL_300). Reads as a heavier, more
// pressed type-specimen sheet — the strip becomes a black-bar
// stamp instead of a quiet hairline frame.
//
// Compare with Specimen (light rules + steel type) and
// Specimen · Inked (light rules + ink type) to see the three
// stages of how loud the categories block can get.

export function BureauSpecimenBoldBody({ tone }: { tone: ShellTone }) {
  return (
