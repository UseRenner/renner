...
// Bureau — WINDOW · D — Source Sans tracked uppercase
// Same text "Have an account? Sign in", in Source Sans at 11px
// with uppercase + letter-spacing 0.14em — reads like a clean
// nav-bar register, distinct from the baseline lowercase sans.
...
export function BureauWindowDBody({ tone }: { tone: ShellTone }) {
  return (
