...
// Bureau — SPECIMEN WALL · INKED.
// Identical to Specimen except the categories strip is rendered
// in INK rather than STEEL_700, matching Index's heavier color
// register. Same size (clamp 15,1.4vw,18), same italic weight
// 300, just darker. Side-by-side with Specimen for an A/B
// comparison of category color.

export function BureauSpecimenInkedBody({ tone }: { tone: ShellTone }) {
  return (
    <div style={{ ...getToneVars(tone), backgroundColor: PAPER, color: INK, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      >
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          {/* Categories — same Specimen framing (two light
              hairlines, edge to edge), but rendered in INK so the
              list reads with Index-level presence. */}
          <section
            style={{
