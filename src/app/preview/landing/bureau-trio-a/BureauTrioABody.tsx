...
export function BureauTrioABody({ tone }: { tone: ShellTone }) {
  return (
...
function TrioField({
  ...
  return (
    <label style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      <span style={{ fontFamily: SERIF, fontSize: 12, fontWeight: 400, color: STEEL_500, fontVariationSettings: '"opsz" 14' }}>
        {label}
      </span>
      <input
        type={type}
