...
// Bureau — WINDOW WALL · INKED.
// Same panel-on-chalk composition as Window, but the categories
// block is rendered in full ink — INK rules above and below,
// INK italic-serif categories distributed edge to edge between
// them. The same "lane" treatment Specimen uses, transplanted
// inside the panel.

export function BureauWindowInkedBody({ tone }: { tone: ShellTone }) {
  return (
    ...
    >
      ...
      >
        ...
        {/* Categories — fully inked: ink rules above and below,
            ink italic-serif distributed edge to edge between
            them. Reads as a lane the way Specimen does. */}
